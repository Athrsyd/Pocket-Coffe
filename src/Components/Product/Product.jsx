      ...
      <div className="py-10 bg-putih min-h-screen px-10">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-5 items-center mb-10">
          <div className="searchBar flex flex-row w-full sm:w-auto items-center gap-2">
            ...
            >
              <FaSearch className={`text-lg font-semibold ${searchTerm.trim() === "" ? "text-gray-400" : "text-accent"}`} />
            </button>
            <button 
              onClick={clearSearch}
              disabled={searchTerm.trim() === ""}
            ...
            >
              <FaTimes className={`text-lg font-semibold ${searchTerm.trim() === "" ? "text-gray-400" : "text-red-500"}`} />
            </button>
          </div>
        ...
        <div data-aos="fade-up" data-aos-duration="2500" className="grid grid-cols-2 md:flex md:flex-row md:flex-wrap gap-7 md:gap-20 my-10 md:my-25 justify-center">
          {filteredCoffe.length > 0 ? (
            ...
            >
              ...
              <h3 className="text-sm md:text-lg text-primary font-bold">{item.nama}</h3>
              <p className="text-xs md:text-base text-secondary font-semibold">{item.harga}</p>
            ...
            <p className="text-gray-500 text-center w-full">Tidak ada produk coffee ditemukan</p>
          )}
        </div>
        ...
        <div data-aos="fade-up" data-aos-duration="2500"  className="grid grid-cols-2 md:flex md:flex-row md:flex-wrap gap-3 md:gap-20 my-10 md:my-25 justify-center">
          {filteredNonCoffe.length > 0 ? (
            ...
            <p className="text-gray-500 text-center w-full">Tidak ada produk non-coffee ditemukan</p>
          )}
        </div>
      </div>
